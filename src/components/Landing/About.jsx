...
const About = () => {
  return (
    <>
      <div className="homePage pb-10" data-aos="fade-up-left">
          ...
          <div className="about grid md:grid-cols-2 grid-cols-1 items-center pt-10">
            ...
            <div className="box">
              ...
              <p className="text-base/8 mb-7">
                ...
                Eligendi alias est necessitatibus soluta facere quisquam dolore
                rerum hic aliquam nostrum?
              </p>
              <div className="p-4 ">
                <div className="flex gap-4 flex-wrap justify-start">
                  {/* CARD 1 */}
                  <div
                    className="w-64 p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 hover:bg-sky-400"
                    data-aos="flip-left"
                  >
                    <svg
